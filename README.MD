...
It also provides persistent QTH session recording and onboard event logging to simplify post-operation analysis and future desktop software integration.

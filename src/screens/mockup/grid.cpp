...
namespace screens::mockup::grid {
    ...
    void draw(ST7796S::MSP4021 &tft) {
        ...
        const int headerH   = ui::settings::mockup::HEADER_HEIGHT;

        area.outerX = 0;
        area.outerY = screens::mockup::header::outerHeight() + gap;
        area.outerW = ui::settings::mockup::GRID_WIDTH;
        area.outerH = tft.height() - area.outerY - btnH - gap;
